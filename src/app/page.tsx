...
fill="white"
      ...
      <defs>
        <clipPath id="clip0_105_2">
          <rect width="130" height="37.2" fill="white" transform="translate(0 0.400391)" />
        </clipPath>
      </defs>
    </svg>
  );
    ...
    >
      <div className="container max-w-7xl">
        ...
        <div className="relative mt-12 h-64">
          <div className="absolute inset-x-0 top-0 h-full bg-gradient-to-t from-background to-transparent" />
          <Image
            src="https://images.unsplash.com/photo-1559652328-9f377a33d745?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwzfHxjeWJlcnNlY3VyaXR5JTIwZGFzaGJvYXJkfGVufDB8fHx8MTc2MTEwMzgzMHww&ixlib=rb-4.1.0&q=80&w=1080"
            ...
            >
              ...
              <CardHeader className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  {tier.name !== "Enterprise" ? "per month" : "Let's talk"}
                </p>
              </CardHeader>
